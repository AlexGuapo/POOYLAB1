...
public class App {
    public static void main(String[] args) {
        ...
        if(retiro) System.out.println("Retiro de " + credito + " exito ya puede ir a pistear" + cuenta1.getSaldo());
        else System.out.println("Lastima margarito, que otro patrocine ");
